        ...
        <div className="container mx-auto px-4 py-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600 mt-2">Browse and manage available workers and affiliated staff</p>
            </div>
                ...
                <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                  <TabsList className="grid w-full grid-cols-1 sm:grid-cols-2 gap-2 h-auto p-2">
                    ...
                    >
                      ...
                      <span className="text-sm text-muted-foreground">({filteredWorkers.filter(w => !w.isAffiliated || w.affiliationStatus !== 'accepted').length})</span>
                    </TabsTrigger>
                    <TabsTrigger 
                      value="affiliated" 
                      className="flex flex-col items-center justify-center p-4 h-auto data-[state=active]:border-2 data-[state=active]:border-blue-500 data-[state=active]:bg-blue-50"
                          ...
                          <CardContent className="p-6">
                            ...
                            <div className="flex flex-col sm:flex-row gap-2">
                              <Button 
                                ...
                                onClick={() => window.open(`/agency/workers/${worker.id}`, '_blank')}
                              >
                                <Building2 className="h-4 w-4 mr-2" />
                                View Details
                              </Button>
