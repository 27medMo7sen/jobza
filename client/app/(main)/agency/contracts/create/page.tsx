...
export default function CreateContractPage() {
  ...
  const [affiliatedWorkers, setAffiliatedWorkers] = useState<
    AffiliatedWorker[]
  >([]);
  const [selectedFamily, setSelectedFamily] = useState<FamilyRequest | null>(
    null
  );
  const [selectedWorker, setSelectedWorker] = useState<AffiliatedWorker | null>(
    null
  );
    ...
    const mockFamilyRequests: FamilyRequest[] = [
      {
        ...
        description:
          "Looking for a reliable full-time housekeeper for our 4-bedroom villa.",
      ...
      },
      {
        ...
        description:
          "Need a caring nanny for our 2 children for 4 hours daily.",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-2">
              Generate employment agreement between family and worker
            </p>
          </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Contract ID: CC-2025-EMP-{Date.now().toString().slice(-6)}
                    </p>
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <p className="font-medium">
                      {selectedFamily?.familyName || "Not Selected"}
                    </p>
                  </div>
                  <div>
                    <p className="text-muted-foreground text-xs">Position</p>
                    <p className="font-medium">
                      {contractForm.position || "Not Selected"}
                    </p>
                  </div>
                  <div>
                      ...
                      <div>
                        ...
                        {selectedFamily ? (
                          <div className="space-y-2">
                            <p>
                              <strong>Name:</strong> {selectedFamily.familyName}
                            </p>
                            <p>
                              <strong>Address:</strong> {selectedFamily.address}
                            </p>
                            <p>
                              <strong>Contact:</strong> {selectedFamily.contact}
                            </p>
                            <p>
                              <strong>ID:</strong> EMP-CC-2025-
                              {selectedFamily.id.toString().padStart(6, "0")}
                            </p>
                          </div>
                        ) : (
                          <Button
                        ...
                        {selectedWorker ? (
                          <div className="space-y-2">
                            ...
                            <p>
                              ...
                              {selectedWorker.passport}
                            </p>
                            <p>
                              <strong>Worker ID:</strong> WK-CC-2025-
                              {selectedWorker.id.toString().padStart(6, "0")}
                            </p>
                          </div>
                        ) : (
                          <Button
                          ...
                          {contractForm.duties.map((duty, index) => (
                            <div key={index} className="flex gap-2">
                              <Input
                                value={duty}
                                onChange={(e) =>
                                  handleDutyChange(index, e.target.value)
                                }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleFormChange("dailyHours", e.target.value)
                          }
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleFormChange("standbyHours", e.target.value)
                          }
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleFormChange("restPeriod", e.target.value)
                          }
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleFormChange("workCycle", e.target.value)
                          }
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleFormChange("weeklyOff", e.target.value)
                          }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleFormChange("monthlySalary", e.target.value)
                          }
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleFormChange("vacation", e.target.value)
                          }
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
              <div className="bg-background border border-border rounded-lg p-8 max-w-md w-full mx-4 shadow-xl text-center">
                ...
                <p className="text-muted-foreground mb-6">
                  The employment agreement has been generated and is ready for
                  signatures.
                </p>
