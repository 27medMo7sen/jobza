...
const mockPendingFamilyRequests = [
  {
    ...
    description:
      "Looking for a reliable full-time housekeeper for our 4-bedroom villa. Must be experienced with large families and able to handle all household tasks.",
    status: "pending",
  },
  {
    id: 2,
    ...
    description:
      "Need a caring nanny for our 2 children (ages 3 and 6) for 4 hours daily, Monday to Friday.",
    status: "pending",
  },
];
...
const mockPendingAffiliationRequests = [
  {
    ...
    location: "Dubai",
    message:
      "I'm interested in joining your agency. I have experience with luxury homes and can provide excellent references.",
    status: "pending",
  },
  {
    id: 2,
    ...
    location: "Abu Dhabi",
    message:
      "Looking for opportunities to work with families through your agency. I'm certified in elderly care and have medical training.",
    status: "pending",
  },
];
...
const mockOngoingFamilyRequests = [
  ...
  },
  {
    ...
    assignedWorkers: [{ id: 3, name: "Ahmed Hassan", status: "accepted" }],
  },
];
...
const mockProcessedFamilyRequests = [
  {
    ...
    status: "completed",
    assignedWorkers: [{ id: 4, name: "Sarah Johnson", status: "accepted" }],
    contractId: 1,
  },
  {
    id: 6,
    ...
    status: "completed",
    assignedWorkers: [{ id: 5, name: "Lisa Chen", status: "accepted" }],
    contractId: 2,
  },
];
...
export default function AgencyDashboard() {
  ...
  const openConfirm = (type: "accept" | "decline", request: any) =>
  ...
  const [pendingRequests, setPendingRequests] = useState(
    mockPendingFamilyRequests
  );
  const [ongoingRequests, setOngoingRequests] = useState(
    mockOngoingFamilyRequests
  );
  const [processedRequests, setProcessedRequests] = useState(
    mockProcessedFamilyRequests
  );
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mt-2">
                    Manage your workers, requests, and contracts
                  </p>
                </div>
            ...
            >
              ...
              <div className="sm:hidden">
                <Select value={activeTab} onValueChange={setActiveTab}>
                  ...
                  <SelectContent>
                    <SelectItem value="family-requests">
                      Families Requests
                    </SelectItem>
                    <SelectItem value="affiliation-requests">
                      Pending Affiliation Requests
                    </SelectItem>
                    <SelectItem value="create-contracts">
                      Create New Contracts
                    </SelectItem>
                    <SelectItem value="contracts-history">
                      Pending Contracts History
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <TabsContent value="family-requests" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Manage family job requests through their lifecycle
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <Tabs defaultValue="pending" className="w-full">
                      ...
                      <TabsContent value="pending" className="space-y-4 mt-4">
                        {pendingRequests.map((request) => (
                          <div
                            key={request.id}
                            className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 border rounded-lg bg-card hover:shadow-sm transition-all duration-200"
                          >
                              ...
                              <div className="flex items-start sm:items-center gap-4">
                                ...
                                <div className="min-w-0 flex-1">
                                  ...
                                  <p className="text-xs text-muted-foreground">
                                    Start: {request.startDate} • Status:{" "}
                                    {request.status}
                                  </p>
                        ...
                        {pendingRequests.length === 0 && (
                          <div className="text-center py-8 text-muted-foreground">
                            ...
                            <p className="text-sm">
                              New job requests from families will appear here
                            </p>
                          </div>
                        )}
                      </TabsContent>
                      ...
                      <TabsContent value="ongoing" className="space-y-4 mt-4">
                        {ongoingRequests.map((request) => (
                          <div
                            key={request.id}
                            className="p-4 border rounded-lg bg-card hover:shadow-sm transition-all duration-200"
                          >
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-3">
                              ...
                              <div className="flex items-center gap-2 self-start sm:self-auto">
                                <Badge variant="outline" className="text-xs">
                                  {request.assignedWorkers.length} Worker
                                  {request.assignedWorkers.length !== 1
                                    ? "s"
                                    : ""}{" "}
                                  Assigned
                                </Badge>
                            ...
                            <div className="space-y-2 mb-3">
                              <p className="text-xs font-medium text-muted-foreground">
                                Assigned Workers & Employer Status:
                              </p>
                                    ...
                                    {worker.status === "accepted" && (
                                      <Button
                                        ...
                                        onClick={() => {
                                          ...
                                          router.push(
                                            `/contracts/create?familyId=${request.id}&workerId=${worker.id}`
                                          );
                                        }}
                                      >
                            ...
                            <div className="flex items-center gap-2 self-start sm:self-auto">
                              <Button
                                ...
                                onClick={() =>
                                  window.open(
                                    `/agency/job-details/${request.id}?tab=ongoing`,
                                    "_blank"
                                  )
                                }
                                className="flex-1 sm:flex-none"
                        ...
                        {ongoingRequests.length === 0 && (
                          <div className="text-center py-8 text-muted-foreground">
                            ...
                            <p className="text-sm">
                              Requests will appear here after you assign workers
                            </p>
                          </div>
                        )}
                      </TabsContent>
                      ...
                      <TabsContent value="processed" className="space-y-4 mt-4">
                          ...
                          >
                            ...
                            <div className="flex items-center gap-2 self-start sm:self-auto">
                              <Button
                                ...
                                onClick={() =>
                                  window.open(
                                    `/contracts/${request.contractId}?role=agency`,
                                    "_blank"
                                  )
                                }
                                className="flex-1 sm:flex-none"
                        ...
                        {processedRequests.length === 0 && (
                          <div className="text-center py-8 text-muted-foreground">
                            ...
                            <p className="text-sm">
                              Completed requests with contracts will appear here
                            </p>
                          </div>
                        )}
                      </TabsContent>
              ...
              <TabsContent value="affiliation-requests" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Review requests from workers wanting to join your agency
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                        ...
                        >
                          <div className="flex-1 min-w-0">
                            <div className="flex items-start sm:items-center gap-4">
                              ...
                              <div className="min-w-0 flex-1">
                                ...
                                <p className="text-sm text-muted-foreground break-words">
                                  {request.specialization} • ⭐ {request.rating}{" "}
                          ...
                          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full sm:w-auto self-start sm:self-auto">
                            <Button
                              ...
                              variant="outline"
                              onClick={() =>
                                router.push(`/agency/workers/${request.id}`)
                              }
                            ...
                            <Button
                              ...
                              onClick={() => openConfirm("decline", request)}
                            >
                            ...
                            <Button
                              ...
                              onClick={() => openConfirm("accept", request)}
                            >
                      ...
                      {mockPendingAffiliationRequests.length === 0 && (
                        <div className="text-center py-8 text-muted-foreground">
                          ...
                          <p className="text-sm">
                            Worker requests to join your agency will appear here
                          </p>
                        </div>
                      )}
                    </div>
              ...
              <TabsContent value="create-contracts" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Generate contracts between families and workers
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      <div className="text-center py-8">
                        ...
                        <p className="text-muted-foreground mb-4">
                          Create contracts by selecting from pending requests
                        </p>
                        <Button asChild>
              ...
              <TabsContent value="contracts-history" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Track the status of all contracts and signatures
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-start sm:items-center gap-4">
                              ...
                              <div className="min-w-0 flex-1">
                                ...
                                <p className="text-xs text-muted-foreground">
                                  Created: {contract.createdAt} • Status:{" "}
                                ...
                                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 mt-2">
                                  ...
                                  <div className="sm:hidden w-full">
                                    <Button
                                      ...
                                      onClick={() =>
                                        router.push(
                                          `/contracts/${contract.id}?role=agency`
                                        )
                                      }
                      ...
                      {mockContracts.length === 0 && (
                        <div className="text-center py-8 text-muted-foreground">
                          ...
                          <p className="text-sm">
                            Contracts will appear here after creation
                          </p>
                        </div>
                      )}
                    </div>
        ...
        <DialogContent>
          ...
          <DialogFooter>
            ...
            {confirmDialog.type === "accept" ? (
              ...
              <Button variant="destructive" onClick={proceedConfirm}>
                Confirm Decline
              </Button>
            )}
          </DialogFooter>
