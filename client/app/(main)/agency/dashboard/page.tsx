    ...
    <div className="max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Manage your agency operations and workers
        </p>
      </div>
      ...
      >
        ...
        <TabsContent value="workers">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Manage your agency workers</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8">
                <Users className="h-12 w-12 text-muted-foreground mx-auto mb-4" />
                <p className="text-muted-foreground">No workers yet</p>
                <Button className="mt-4">Add Workers</Button>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="requests">
          <Card>
            <CardHeader>
              <CardTitle>Family Requests</CardTitle>
              <CardDescription>Manage incoming family requests</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8">
