...
export default function LongTermBookingPage() {
  ...
  const calculateWorkload = () => {
    ...
    if (formData.children03 + formData.children47 + formData.children814 > 0) {
      adjustments +=
        (formData.children03 + formData.children47 + formData.children814) *
        1.2;
    }
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    value={formData.standbyHours.toString()}
                    onValueChange={(value) =>
                      handleInputChange("standbyHours", parseInt(value))
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("kitchens", parseInt(e.target.value))
                      }
                      min="1"
                    />
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        handleInputChange("cooking", checked)
                      }
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        handleInputChange("laundry", checked)
                      }
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        handleInputChange("grocery", checked)
                      }
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        handleInputChange("petCare", checked)
                      }
                    />
              ...
              {(formData.primaryRole === "caregiver" ||
                formData.primaryRole === "combined") && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          handleInputChange("mobility", checked)
                        }
                      />
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          handleInputChange("personalCare", checked)
                        }
                      />
                      <Label htmlFor="personalCare">
                        Personal/private care required
                      </Label>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div
                      className="flex items-center space-x-3 p-3 border rounded-lg cursor-pointer hover:border-blue-500"
                      onClick={() =>
                        handleInputChange("livingArrangement", "live-in")
                      }
                    >
                      <input
                        type="radio"
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Worker stays at employer's home
                        </p>
                      </div>
                    </div>
                    <div
                      className="flex items-center space-x-3 p-3 border rounded-lg cursor-pointer hover:border-blue-500"
                      onClick={() =>
                        handleInputChange("livingArrangement", "live-out")
                      }
                    >
                      <input
                        type="radio"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="Converted Space">
                            Converted Space
                          </SelectItem>
                        </SelectContent>
                      </Select>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleInputChange("mealPlan", value)
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
                        ...
                        <SelectContent>
                          <SelectItem value="1-1-1 (Breakfast, Lunch, Dinner)">
                            1-1-1 (Breakfast, Lunch, Dinner)
                          </SelectItem>
                          <SelectItem value="1-0-1 (Breakfast and Dinner)">
                            1-0-1 (Breakfast and Dinner)
                          </SelectItem>
                          <SelectItem value="0-0-1 (Dinner only)">
                            0-0-1 (Dinner only)
                          </SelectItem>
                          <SelectItem value="No meals provided">
                            No meals provided
                          </SelectItem>
                        </SelectContent>
                      </Select>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleInputChange("feedingAllowance", e.target.value)
                        }
                      />
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        value={formData.externalLodge}
                        onValueChange={(value) =>
                          handleInputChange("externalLodge", value)
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
                  ...
                  <div className="p-4 border rounded-lg">
                    <div className="flex items-start space-x-3">
                      <input
                        ...
                        onChange={() =>
                          handleInputChange("bookingType", "instant")
                        }
                      />
                      <div>
                        <h4 className="font-medium">
                          Instant Booking (Start Date: Today)
                        </h4>
                        <p className="text-sm text-gray-600">
                          Primary agency has 72 hours to fulfill placement
                        </p>
                        <p className="text-sm text-yellow-600 mt-1">
                          ⚠️ If not fulfilled, fallback agencies will be
                          contacted
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="p-4 border rounded-lg">
                    <div className="flex items-start space-x-3">
                      <input
                        ...
                        onChange={() =>
                          handleInputChange("bookingType", "future")
                        }
                      />
                      <div>
                        <h4 className="font-medium">Future Date Booking</h4>
                        <p className="text-sm text-gray-600">
                          Specify start date for fulfillment
                        </p>
                        <Input
                          type="date"
                          className="mt-2"
                        ...
                        />
                        <p className="text-sm text-yellow-600 mt-1">
                          ⚠️ Agency has 48 hours from booking submission to
                          fulfill
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Your booking request has been submitted to BrightHands
                          Agency
                        </p>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          BrightHands Agency has 72 hours to fulfill your
                          request
                        </p>
                        <p className="text-sm text-yellow-600 mt-1">
                          Deadline: Oct 15, 2023, 10:30 AM
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-medium">
                      {formData.primaryRole || "Not selected"}
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {calculateWorkload()} hours/day
                    </p>
                  </div>
                  <div>
                    <p className="text-gray-600 text-xs">Estimated Salary</p>
                    <p className="font-medium">
                      EGP {calculateSalary().min} – EGP {calculateSalary().max}
                    </p>
                  </div>
                  <div>
                    <p className="text-gray-600 text-xs">Living Arrangement</p>
                    <p className="font-medium">
                      {formData.livingArrangement || "Not selected"}
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-yellow-700">
                      Long-term bookings are only available to subscribed
                      members.
                    </p>
