...
export default function SelectAgenciesPage() {
  ...
  const filteredAgencies = mockAgencies.filter((agency) => {
    ...
    const matchesLocation =
      !selectedLocation || agency.location.includes(selectedLocation);
    const matchesSpecialization =
      !selectedSpecialization ||
      agency.specializations.includes(selectedSpecialization);
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                Choose from our network of verified domestic help agencies
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6 mb-8">
              <div className="flex flex-col lg:flex-row gap-4">
                ...
                <div className="flex items-center space-x-2 lg:w-auto">
                  ...
                  />
                  <Label htmlFor="premiumOnly" className="text-sm">
                    Premium Only
                  </Label>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between mb-6">
              <p className="text-gray-600">
                Showing{" "}
                <span className="font-semibold">{filteredAgencies.length}</span>{" "}
                of <span className="font-semibold">{mockAgencies.length}</span>{" "}
                agencies
              </p>
              <div className="flex items-center space-x-2">
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex flex-col items-end space-y-2">
                        <Badge
                          className={getBackgroundColor(agency.background)}
                        >
                          {agency.background === "verified"
                            ? "✓ Verified"
                            : "Pending"}
                        </Badge>
                        <Checkbox
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="text-center p-2 bg-gray-50 rounded">
                        ...
                        <Badge
                          className={getResponseTimeColor(agency.responseTime)}
                        >
                          {agency.responseTime}
                        </Badge>
                      </div>
                      <div className="text-center p-2 bg-gray-50 rounded">
                        ...
                        <Badge
                          className={getSuccessRateColor(agency.successRate)}
                        >
                          {agency.successRate}
                        </Badge>
                      </div>
                ...
                <div className="container mx-auto max-w-7xl">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex space-x-3">
                      ...
                      <Button>
                        Continue with {selectedAgencies.length} Agenc
