...
const isAgency = (userRole: "worker" | "employer" | "agency") =>
  userRole === "agency";

// Get appropriate back navigation based on user role
const getBackNavigation = (
  userRole: "worker" | "employer" | "agency",
  router: any
) => {
  switch (userRole) {
    case "employer":
  ...
  const renderSignaturePanel = () => {
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg bg-white hover:bg-gray-50 transition-colors">
                ...
                {contractData.employerSigned ? (
                  ...
                  <Badge
                    variant="outline"
                    className="text-yellow-600 border-yellow-600 px-3 py-1"
                  >
    ...
    return (
      <Card>
        <CardHeader>
          <CardTitle>
            {userRole === "employer" ? "Employer" : "Worker"} Signature
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="text-center">
          ...
          >
            {isSubmitting
              ? "Submitting..."
              : `Sign as ${userRole === "employer" ? "Employer" : "Worker"}`}
          </Button>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <p>
                          ...
                          {contractData.agency.address}
                        </p>
                        <p>
                          <strong>Contact:</strong>{" "}
                          {contractData.agency.contact}
                        </p>
                        <p>
