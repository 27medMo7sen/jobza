...
export default function AdminLayout({
  ...
  useEffect(() => {
    ...
    // Check if user has admin or superadmin role (superadmin can access admin routes)
  ...
  // Don't render children if user is not an admin/superadmin or not authenticated
  if (
    !user ||
    !token ||
