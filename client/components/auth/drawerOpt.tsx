...
//   import { closeDrawer } from "@/lib/slices/uiSlice";
  ...
  export const DrawerOpt = ({ drawerRef }: { drawerRef: React.RefObject<HTMLButtonElement | null> }) => {
            ...
            <div className="flex items-center justify-center mt-4">
              ...
              >
                <InputOTPGroup>
                  <InputOTPSlot
                    index={0}
                    className={`${isLoading ? "opacity-50 cursor-not-allowed" : "border-input"} ${error ? "border-red-500" : ""}`}
