      ...
      {navigationItems.map((item) => {
        ...
        if (item.onClick) {
          return (
            ...
            >
              <item.icon className={cn("h-4 w-4 flex-shrink-0", isLogout && "text-red-600 dark:text-red-400")} />
              {!isCollapsed && (
                <>
                  {item.title}
                  {item.badge && (
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="flex items-center justify-center h-16 px-4 border-b border-sidebar-border">
              <Link href="/" className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold text-gray-900 dark:text-white">Jobza</span>
              </Link>
            </div>
            ...
            <div className="border-t border-sidebar-border p-4">
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="w-full justify-start gap-3 px-3 py-2 text-sm h-auto text-gray-700 dark:text-white/90 hover:bg-gray-100 dark:hover:bg-white/10 hover:text-gray-900 dark:hover:text-white">
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-xs text-gray-600 dark:text-white/70">{userEmail}</span>
                    </div>
                  </Button>
                </DropdownMenuTrigger>
